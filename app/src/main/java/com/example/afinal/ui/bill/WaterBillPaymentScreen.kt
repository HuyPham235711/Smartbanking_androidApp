...
fun WaterBillPaymentScreen(
    ...
    val waterProviders = listOf(
        "Công ty Cấp nước Sài Gòn (SAWACO) – TP. Hồ Chí Minh",
        ...
        "Công ty TNHH MTV Cấp nước Đà Nẵng (Dawaco)",
        "Công ty Cổ phần Nước sạch Quảng Ninh",
        "Công ty Cấp nước Cần Thơ (CANTHOWASUCO)",
        "Công ty Cổ phần Nước sạch Hải Phòng (Hai Phong Water JSC)",
        "Công ty Cổ phần Cấp nước An Giang"
    )
    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text(
                    text = "Thông tin hóa đơn tiền nước",
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.Bold
                )
                ...
                ExposedDropdownMenuBox(
                    ...
                    ExposedDropdownMenu(
                        ...
                        waterProviders.forEach { provider ->
                            DropdownMenuItem(
                                text = { Text(provider, style = MaterialTheme.typography.bodySmall) },
                                onClick = {
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text("Nhập mã khách hàng") },
                ...
                if (billInfo == null) {
                    Button(
                        onClick = {
                            viewModel.lookupBill(BillType.WATER, customerCode, selectedProvider)
                        },
                        modifier = Modifier.fillMaxWidth(),
